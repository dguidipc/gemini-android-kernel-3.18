...
/* LOCAL PROTOTYPES */
/* /////////////////////////////////////////////////////////////////////////// */
void InitializeFUSB301Interrupt(BOOL blnEnable);
void InitializeFUSB301Timer(BOOL blnEnable);
void InitializeFUSB301Variables(void);
void InitializeFUSB301(void);
void DisableFUSB301StateMachine(void);
void EnableFUSB301StateMachine(void);
void StateMachineFUSB301(struct usbtypc *typec);
...
void GetFUSB301TypeCStatus(unsigned char abytData[]);
