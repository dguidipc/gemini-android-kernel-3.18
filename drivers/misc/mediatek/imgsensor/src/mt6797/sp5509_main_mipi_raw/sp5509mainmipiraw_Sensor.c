...
#include "sp5509mainmipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = SP5509_MAIN_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
  ...
  .custom5 = {
	...
	.i2c_addr_table = {0x50,0x40,0xff},//record sensor support all write id addr, only supprt 4must end with 0xff
...
{
	printk("sp5509 main i2c write id: 0x%x, ReadOut sensor id: 0x%x, \n", imgsensor.i2c_write_id,(read_cmos_sensor(0x0f16)+1)); 
    return (read_cmos_sensor(0x0f16)+1);
